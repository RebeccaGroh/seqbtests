...
#------------------------------------------------------------------------------
# erst später einbauen, wenn das richtige Ergebnis angezeigt wird if (is.null(test)) { ## test for better threshold
# <- b_test$posterior.probabilities[3] } else if (test == 'equal') { threshold <- b_test$posterior.probabilities[2] +
# b_test$posterior.probabilities[3] } else { threshold <- b_test$posterior.probabilities[3] }
