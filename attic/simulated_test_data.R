...
# 5.2.1 Bayesian correlated t-test ---------------------------------------------
...
simulation_b1_gt2 <- grid.arrange(error_plot, time_plot, nrow = 1)
...
################################################################################
################### ÜBER WAS SOLL HIERBEI AGGREGIERT WERDEN ####################
################################################################################
...
# 5.2.2 Bayesian Signed Ranks test ---------------------------------------------
# Data sets according to mu 
...
# SAVE DATA 
# simulation_b_signed_multiple_data_mu <- test_result
# setwd("H:/MA/simulation_data")
