...
accuracy and F1 Score, the harmonic mean of precision and recall, of the algorithms performances. However, for 
...
assign("get_replication", sepcific_get_replication, envir=as.environment("package:seqbtests"))
lockBinding("get_replication", as.environment("package:seqbtests"))
